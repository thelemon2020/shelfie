<div class="overflow-x-scroll">
    ...
    <form wire:submit.prevent="submit">
        <div class="grid grid-rows-1 grid-flow-col">
            ...
            @endforeach
            <button type="button" class="bg-blue-500 p-4 rounded rounded-lg text-white" wire:click="createSegment">
        ...
        <button type="submit" class="bg-blue-500 rounded p-4 rounded-md text-lg text-white">Update</button>
    </form>
</div>
