...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-md">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-md leading-7 font-semibold"><a href="https://laravel.com/docs"
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-md leading-7 font-semibold"><a href="https://laracasts.com"
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-md leading-7 font-semibold"><a href="https://laravel-news.com/"
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-md leading-7 font-semibold text-gray-900 dark:text-white">Vibrant
                                Ecosystem
                            </div>
                        </div>
